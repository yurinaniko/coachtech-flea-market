...
Seederでは10件の商品を作成していますが、

* ログインユーザーが出品した商品は一覧に表示されない仕様のため
  → 商品一覧・検索結果では **9件表示** されます。

※マイページの「出品した商品」には表示されます。
...
| 種別         | 名前      | メールアドレス                                           | パスワード    |
| ---------- | ------- | ------------------------------------------------- | -------- |
| 出品者A       | 出品者A    | [seller1@example.com](mailto:seller1@example.com) | password |
| 出品者B       | 出品者B    | [seller2@example.com](mailto:seller2@example.com) | password |
| テストユーザー | テストユーザー | [test@test.com](mailto:test@test.com)             | password |

※すべてのユーザーはメール認証済みです。
- テストユーザーは何も紐づいていません。
- 出品者Aと出品者Bはそれぞれ5つずつ商品を出品、3つの商品は出品者Aと出品者で取引中です。
